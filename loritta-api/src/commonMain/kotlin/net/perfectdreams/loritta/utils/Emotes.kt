...
object Emotes {
	...
	val LORI_KAMEHAMEHA: LorittaEmote by resettableLazy(lazyMgr) { getEmote("lori_kamehameha") }
	val LORI_BARF: LorittaEmote by resettableLazy(lazyMgr) { getEmote("lori_barf") }
	val LORI_WATER: LorittaEmote by resettableLazy(lazyMgr) { getEmote("lori_water") }
	val LORI_POINT: LorittaEmote by resettableLazy(lazyMgr) { getEmote("lori_point") }
	val LORI_SOB: LorittaEmote by resettableLazy(lazyMgr) { getEmote("lori_sob") }
