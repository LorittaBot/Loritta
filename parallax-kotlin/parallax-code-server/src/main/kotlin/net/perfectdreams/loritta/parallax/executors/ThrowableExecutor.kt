...
object ThrowableExecutor : PacketExecutor {
    suspend fun executes(ackId: Long, data: ParallaxThrowablePacket, guildId: Long, channelId: Long, clusterUrl: String, outputStream: BufferedWriter) {
        println("Throwable! ${data.message}")
