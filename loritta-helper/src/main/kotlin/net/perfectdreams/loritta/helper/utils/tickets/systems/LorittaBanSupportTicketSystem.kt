    ...
    override val ticketCreatedMessage: InlineMessage<*>.(User, I18nContext) -> Unit = { sender, language ->
        content = (
                listOf(
                    ...
                    LorittaReply(
                        "Você PRECISA ter aberto um apelo de ban pelo https://appeals.loritta.website/br/?utm_source=discord&utm_medium=link&utm_campaign=unban-appeal&utm_content=appeal-ban-support ANTES de pedir ajuda sobre o seu apelo! Se você não abriu um apelo pelo website ainda, abra agora! Nós não iremos te desbanir se você não abrir um apelo. Se você já abriu um apelo, envie o ID do apelo aqui.",
                        mentionUser = false
                    )
                )
                )
