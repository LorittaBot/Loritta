...
object DemonGIF {
	fun getGIF(_toUse1: BufferedImage, localeId: String): File {
		...
		val popukoHand = ImageIO.read(File(Loritta.ASSETS, "demon/popuko_hand1.png"))
		val popukoHand2 = ImageIO.read(File(Loritta.ASSETS, "demon/popuko_hand2.png"))
		val popukoHand3 = ImageIO.read(File(Loritta.ASSETS, "demon/popuko_hand3.png"))
		val popukoHand4 = ImageIO.read(File(Loritta.ASSETS, "demon/popuko_hand4.png"))
		val popukoHand5 = ImageIO.read(File(Loritta.ASSETS, "demon/popuko_hand5.png"))
		...
		var begone = ImageIO.read(File(Loritta.ASSETS, "demon/${lang}_begone.png"))
		var notYou = ImageIO.read(File(Loritta.ASSETS, "demon/${lang}_notyou.png"))
		var notHim = ImageIO.read(File(Loritta.ASSETS, "demon/${lang}_nothim.png"))
