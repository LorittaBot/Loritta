...
class BotInfoCommand : CommandBase("botinfo") {
	...
	override fun run(context: CommandContext, locale: BaseLocale) {
		...
		embed.setDescription(context.locale.get("BOTINFO_EMBED_INFO", LORITTA_SHARDS.getGuilds().size, LorittaLauncher.loritta.lorittaShards.getUsers().size, sb.toString(), LorittaLauncher.loritta.commandManager.commandMap.size))
