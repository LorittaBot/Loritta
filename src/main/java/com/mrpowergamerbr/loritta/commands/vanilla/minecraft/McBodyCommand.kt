...
class McBodyCommand : CommandBase() {
	...
	override fun getDescription(): String {
		return "Mostra o corpo de uma conta do Minecraft, caso a conta não exista ele irá mostrar a skin padrão (Steve)"
	}
	...
	override fun run(context: CommandContext) {
		if (context.args.isNotEmpty()) {
			...
			builder.setTitle("<:grass:330435576392318978> Estátua de " + nickname)
