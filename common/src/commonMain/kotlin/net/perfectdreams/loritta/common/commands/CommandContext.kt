...
abstract class CommandContext(
    ...
    open val loritta: net.perfectdreams.loritta.common.LorittaBot,
    val locale: BaseLocale,
    val user: User,
    val message: Message,
    open val channel: MessageChannel
) {
    suspend fun sendMessage(block: net.perfectdreams.loritta.common.builder.MessageBuilder.() -> (Unit)) = channel.sendMessage(block)
     ...
     */
    suspend fun sendReply(content: String, prefix: Emote, inReplyToUser: User = user, mentionSenderHint: Boolean = false, block: net.perfectdreams.loritta.common.builder.MessageBuilder.() -> Unit = {})
     ...
     * @param mentionSenderHint if the user should be mentioned in the reply, implementations may decide to not add the mention if it isn't needed.
     */
    suspend fun sendReply(content: String, prefix: String = Emotes.defaultStyledPrefix.asMention, inReplyToUser: User = user, mentionSenderHint: Boolean = false, block: net.perfectdreams.loritta.common.builder.MessageBuilder.() -> Unit = {}) = sendMessage {
     ...
     */
    suspend fun sendReply(reply: LorittaReply, block: net.perfectdreams.loritta.common.builder.MessageBuilder.() -> Unit = {}) = sendMessage {
        styled(reply)
        apply(block)
     ...
     */
    suspend fun sendReplies(block: net.perfectdreams.loritta.common.builder.ContextualMultiReplyBuilder.() -> Unit = {}) = sendMessage {
        val builder = net.perfectdreams.loritta.common.builder.ContextualMultiReplyBuilder(this@CommandContext).apply(block)
     ...
     */
    fun fail(content: String, prefix: Emote, block: net.perfectdreams.loritta.common.builder.MessageBuilder.() -> Unit = {}): Nothing = fail(
        LorittaReply(
     ...
     * @see CommandException
     */
    fun fail(content: String, prefix: String = Emotes.defaultStyledPrefix.asMention, block: net.perfectdreams.loritta.common.builder.MessageBuilder.() -> Unit = {}): Nothing = fail(
        LorittaReply(
            content, prefix
        ),
        block
     ...
     * @see CommandException
     */
    fun fail(reply: LorittaReply, block: net.perfectdreams.loritta.common.builder.MessageBuilder.() -> Unit = {}): Nothing = fail {
        styled(reply)
        apply(block)
    }
     ...
     * @see CommandException
     */
    fun fail(block: net.perfectdreams.loritta.common.builder.MessageBuilder.() -> Unit = {}): Nothing = throw CommandException(
