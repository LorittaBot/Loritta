        ...
        if (author != null) {
            content.div(classes = "embedAuthor-3l5luH embedMargin-UO5XwE") {
                ...
                if (author.iconUrl != null) {
                    img(src = author.iconUrl, classes = "embedAuthorIcon--1zR3L")
                }

                if (author.url != null) {
                    a(href = author.url, classes = "anchor-3Z-8Bb anchorUnderlineOnHover-2ESHQB embedAuthorNameLink-1gVryT embedLink-1G1K1D embedAuthorName-3mnTWj") {
