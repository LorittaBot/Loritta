                                ...
                                for (user in group.users.sortedBy { it.name }) {
                                    ...
                                    div(classes = "staff-info") {
                                        ...
                                        if (lastFmSocialNetwork != null) {
                                            val lastFmInfo = LorittaWebsiteBackend.lastFmStaffData?.get(lastFmSocialNetwork.handle)
                                                ...
                                                div(classes = "staff-description") {
                                                    for (aboutMe in splitAboutMe) {
                                                        ...
                                                        for (match in matches) {
                                                            ...
                                                            if (LorittaWebsiteBackend.webEmotes.emotes.contains(emoteName)) {
                                                        ...
                                                        for (section in sections) {
                                                            when (section) {
                                                                is AboutMeLorittaWebsiteEmote -> {
                                                                    val etherealGambiEmote = LorittaWebsiteBackend.webEmotes.emotes[section.emoteFile]!!
