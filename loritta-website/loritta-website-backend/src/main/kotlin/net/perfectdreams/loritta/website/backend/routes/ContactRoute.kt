...
import net.perfectdreams.loritta.website.backend.views.ContactView

class ContactRoute(val showtime: LorittaWebsiteBackend) : LocalizedRoute(showtime, RoutePath.CONTACT) {
