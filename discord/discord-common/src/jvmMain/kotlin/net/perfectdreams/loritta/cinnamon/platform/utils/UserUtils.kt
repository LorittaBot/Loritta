...
object UserUtils {
     ...
     */
    fun buildDailyTaxMessage(i18nContext: I18nContext, lorittaWebsiteUrl: String, userId: UserId, data: UserDailyTaxWarnDirectMessage): MessageCreateBuilder.() -> Unit = {
        embed {
     ...
     * Builds a daily tax message for the [data]
     */
    fun buildDailyTaxMessage(i18nContext: I18nContext, lorittaWebsiteUrl: String, userId: UserId, data: UserDailyTaxTaxedDirectMessage): MessageCreateBuilder.() -> Unit = {
        embed {
            title = i18nContext.get(I18nKeysData.InactiveDailyTax.Title)
