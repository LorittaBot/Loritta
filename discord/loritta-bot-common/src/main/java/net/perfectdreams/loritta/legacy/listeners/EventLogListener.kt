...
class EventLogListener(internal val loritta: Loritta) : ListenerAdapter() {
	...
	override fun onGuildMessageDelete(event: GuildMessageDeleteEvent) {
		...
		GlobalScope.launch(loritta.coroutineDispatcher) {
			...
			val eventLogConfig = serverConfig.getCachedOrRetreiveFromDatabaseAsync<EventLogConfig?>(net.perfectdreams.loritta.legacy.utils.loritta, ServerConfig::eventLogConfig) ?: return@launch
