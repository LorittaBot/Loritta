...
import net.perfectdreams.loritta.legacy.tables.servers.moduleconfigs.AutoroleConfigs
import net.perfectdreams.loritta.legacy.tables.servers.moduleconfigs.EconomyConfigs
import net.perfectdreams.loritta.legacy.tables.servers.moduleconfigs.EventLogConfigs
import net.perfectdreams.loritta.legacy.tables.servers.moduleconfigs.InviteBlockerConfigs
import net.perfectdreams.loritta.legacy.tables.servers.moduleconfigs.LevelConfigs
import net.perfectdreams.loritta.legacy.tables.servers.moduleconfigs.MiscellaneousConfigs
import net.perfectdreams.loritta.legacy.tables.servers.moduleconfigs.ModerationConfigs
import net.perfectdreams.loritta.legacy.tables.servers.moduleconfigs.StarboardConfigs
import net.perfectdreams.loritta.legacy.tables.servers.moduleconfigs.WelcomerConfigs
