package net.perfectdreams.loritta.legacy.utils.minecraft
...
import net.perfectdreams.loritta.legacy.Loritta.Companion.GSON
import net.perfectdreams.loritta.legacy.utils.extensions.success
import java.util.*
