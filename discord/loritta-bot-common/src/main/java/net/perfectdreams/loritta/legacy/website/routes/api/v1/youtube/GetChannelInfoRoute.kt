package net.perfectdreams.loritta.legacy.website.routes.api.v1.youtube
...
import net.perfectdreams.loritta.legacy.tables.CachedYouTubeChannelIds
...
class GetChannelInfoRoute(val loritta: LorittaDiscord) : BaseRoute("/api/v1/youtube/channel") {
	...
	override suspend fun onRequest(call: ApplicationCall) {
		...
		if (!net.perfectdreams.loritta.legacy.utils.loritta.connectionManager.isTrusted(channelLink)) {
		...
		val key = net.perfectdreams.loritta.legacy.utils.loritta.config.youtube.apiKey
