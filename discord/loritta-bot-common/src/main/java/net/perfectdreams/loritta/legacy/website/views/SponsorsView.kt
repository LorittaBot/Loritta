...
import net.perfectdreams.loritta.legacy.sweetmorenitta.utils.generateSponsorNoWrap
            ...
            div(classes = "media") {
                div(classes = "media-body") {
                    div {
                        ...
                        net.perfectdreams.loritta.legacy.LorittaLauncher.loritta.sponsors.forEach {
