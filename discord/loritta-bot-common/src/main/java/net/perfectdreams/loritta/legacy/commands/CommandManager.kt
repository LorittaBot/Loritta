package net.perfectdreams.loritta.legacy.commands

import net.perfectdreams.loritta.legacy.Loritta
import net.perfectdreams.loritta.legacy.commands.nashorn.NashornCommand
import net.perfectdreams.loritta.legacy.commands.vanilla.administration.*
import net.perfectdreams.loritta.legacy.commands.vanilla.discord.*
...
import net.perfectdreams.loritta.legacy.commands.vanilla.minecraft.*
import net.perfectdreams.loritta.legacy.commands.vanilla.misc.*
import net.perfectdreams.loritta.legacy.commands.vanilla.music.LyricsCommand
import net.perfectdreams.loritta.legacy.commands.vanilla.pokemon.PokedexCommand
import net.perfectdreams.loritta.legacy.commands.vanilla.social.*
import net.perfectdreams.loritta.legacy.commands.vanilla.undertale.UndertaleBattleCommand
import net.perfectdreams.loritta.legacy.commands.vanilla.undertale.UndertaleBoxCommand
import net.perfectdreams.loritta.legacy.commands.vanilla.utils.*
