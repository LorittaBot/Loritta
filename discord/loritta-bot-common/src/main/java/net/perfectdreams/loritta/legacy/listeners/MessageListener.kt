...
import net.perfectdreams.loritta.legacy.modules.*
...
import net.perfectdreams.loritta.legacy.utils.chance
...
class MessageListener(val loritta: Loritta) : ListenerAdapter() {
	...
	suspend fun checkCommandsAndDispatch(lorittaMessageEvent: LorittaMessageEvent, serverConfig: ServerConfig, locale: BaseLocale, lorittaUser: LorittaUser): Boolean {
		...
		val startsWithLorittaMention = firstLabel == "<@${net.perfectdreams.loritta.legacy.utils.loritta.discordConfig.discord.clientId}>" || firstLabel == "<@!${net.perfectdreams.loritta.legacy.utils.loritta.discordConfig.discord.clientId}>"
