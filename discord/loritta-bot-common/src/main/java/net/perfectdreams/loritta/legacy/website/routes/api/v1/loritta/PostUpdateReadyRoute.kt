...
import net.perfectdreams.loritta.legacy.utils.PatchData
	...
	override suspend fun onAuthenticatedRequest(call: ApplicationCall) {
		...
		when (type) {
			...
			"setRestartTimer" -> {
				...
				net.perfectdreams.loritta.legacy.utils.loritta.patchData.willRestartAt = willRestartAt
				call.respondJson(jsonObject())
			}
			"setPatchNotesPost" -> {
				...
				net.perfectdreams.loritta.legacy.utils.loritta.patchData.patchNotes = PatchData.PatchNotes(
