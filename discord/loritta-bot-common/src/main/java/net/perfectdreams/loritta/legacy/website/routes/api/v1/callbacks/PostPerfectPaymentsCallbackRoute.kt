		...
		if (status == "CHARGED_BACK") {
			...
			if (metadata != null) {
				...
				if (bundleType == "dreams") {
					...
					sendPaymentApprovedDirectMessage(internalPayment.userId, loritta.localeManager.getLocaleById("default"), "${net.perfectdreams.loritta.legacy.utils.loritta.instanceConfig.loritta.website.url}support")
