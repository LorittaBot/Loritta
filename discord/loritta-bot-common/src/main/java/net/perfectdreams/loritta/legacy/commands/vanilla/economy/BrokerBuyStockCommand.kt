...
class BrokerBuyStockCommand(loritta: LorittaDiscord) : DiscordAbstractCommandBase(loritta, BrokerCommand.ALIASES.flatMap { listOf("$it buy", "$it comprar") }, CommandCategory.ECONOMY) {
	companion object {
