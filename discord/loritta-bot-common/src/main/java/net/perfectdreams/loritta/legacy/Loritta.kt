...
import net.perfectdreams.loritta.legacy.commands.CommandManager
import net.perfectdreams.loritta.legacy.listeners.*
import net.perfectdreams.loritta.legacy.modules.AddReactionForHeathecliffModule
...
import net.perfectdreams.loritta.legacy.tables.StarboardMessages
import net.perfectdreams.loritta.legacy.tables.UserSettings
import net.perfectdreams.loritta.legacy.threads.RaffleThread
import net.perfectdreams.loritta.legacy.threads.RemindersThread
...
import net.perfectdreams.loritta.legacy.platform.discord.utils.RateLimitChecker
import net.perfectdreams.loritta.legacy.tables.*
...
class Loritta(
	...
	var newWebsite: net.perfectdreams.loritta.legacy.website.LorittaWebsite? = null
	...
	fun startWebServer() {
		...
		loritta.newWebsiteThread = thread(true, name = "Website Thread") {
			val nWebsite = net.perfectdreams.loritta.legacy.website.LorittaWebsite(loritta, instanceConfig.loritta.website.url, instanceConfig.loritta.website.folder)
