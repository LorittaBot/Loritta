...
import net.perfectdreams.loritta.legacy.profile.badges.*
import net.perfectdreams.loritta.legacy.platform.discord.LorittaDiscord
import net.perfectdreams.loritta.legacy.profile.ArtistBadge
import net.perfectdreams.loritta.legacy.profile.Badge
import net.perfectdreams.loritta.legacy.profile.DiscordNitroBadge
import net.perfectdreams.loritta.legacy.profile.DiscordUserFlagBadge
