...
import net.perfectdreams.loritta.legacy.analytics.InternalAnalyticSender
import net.perfectdreams.loritta.legacy.utils.eventlog.DeleteOldStoredMessagesTask
import net.perfectdreams.loritta.legacy.utils.networkbans.ApplyBansTask
import net.perfectdreams.loritta.legacy.website.OptimizeAssetsTask
import net.perfectdreams.loritta.legacy.youtube.CreateYouTubeWebhooksTask
import net.perfectdreams.loritta.legacy.utils.LorittaDailyShopUpdateTask
import net.perfectdreams.loritta.legacy.utils.giveaway.SpawnGiveawayTask
