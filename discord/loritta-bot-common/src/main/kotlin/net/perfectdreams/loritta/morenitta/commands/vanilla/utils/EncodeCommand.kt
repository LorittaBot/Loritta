...
class EncodeCommand(loritta: LorittaBot) : AbstractCommand(
    loritta,
    "encode",
    listOf("codificar", "encrypt", "criptografar", "hash"),
    ...
    override fun getDescriptionKey() = LocaleKeyData(
        ...
        listOf(
            LocaleStringData(
                listOf("md2", "md5", "sha1", "sha256", "sha384", "sha512", "rot13", "uuid", "base64").joinToString(
                    ", ",
                    transform = { "`$it`" })
            )
        )
