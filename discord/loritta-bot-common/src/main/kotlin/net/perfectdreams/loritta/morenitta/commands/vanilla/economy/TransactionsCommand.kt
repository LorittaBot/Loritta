...
class TransactionsCommand(loritta: LorittaBot) : DiscordAbstractCommandBase(
    loritta,
    listOf("transactions", "transações", "transacoes", "transaçoes"),
    ...
    suspend fun sendTransactionEmbed(
