...
class LoraffleCommand(loritta: LorittaBot) : AbstractCommand(
    loritta,
    "loraffle",
    listOf("rifa", "raffle", "lorifa"),
    ...
    override suspend fun run(context: CommandContext, locale: BaseLocale) {
        ...
        context.reply(
            ...
            LorittaReply(
                context.locale["commands.command.raffle.resultsIn", DateUtils.formatDateWithRelativeFromNowAndAbsoluteDifference(
                    started + 3600000,
                    locale
                )],
                prefix = "\uD83D\uDD52",
