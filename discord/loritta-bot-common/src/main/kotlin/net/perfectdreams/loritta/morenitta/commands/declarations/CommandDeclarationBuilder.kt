package net.perfectdreams.loritta.morenitta.commands.declarations

import net.perfectdreams.loritta.common.commands.CommandCategory
import net.perfectdreams.loritta.common.locale.LocaleKeyData
import kotlin.reflect.KClass

fun command(parent: KClass<*>, labels: List<String>, category: net.perfectdreams.loritta.common.commands.CommandCategory, block: CommandDeclarationBuilder.() -> (Unit)): CommandDeclarationBuilder {
    return CommandDeclarationBuilder(parent, labels, category).apply(block)
}

class CommandDeclarationBuilder(val parent: KClass<*>, val labels: List<String>, val category: net.perfectdreams.loritta.common.commands.CommandCategory) {
