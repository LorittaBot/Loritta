...
object DateUtils {
     ...
     */
    fun formatDateWithRelativeFromNowAndAbsoluteDifference(time: OffsetDateTime, locale: BaseLocale) =
        formatDateWithRelativeFromNowAndAbsoluteDifference(time.toInstant(), locale)
     ...
     * @return the humanized string
     */
    fun formatDateWithRelativeFromNowAndAbsoluteDifference(instant: Instant, locale: BaseLocale) =
        formatDateWithRelativeFromNowAndAbsoluteDifference(instant.toEpochMilli(), locale)
    ...
    fun formatDateDiff(fromDate: Calendar, toDate: Calendar, locale: BaseLocale): String {
        ...
        val names = arrayOf(
            locale["loritta.date.year"],
            locale["loritta.date.years"],
            locale["loritta.date.month"],
            locale["loritta.date.months"],
            locale["loritta.date.day"],
            locale["loritta.date.days"],
            locale["loritta.date.hour"],
            locale["loritta.date.hours"],
            locale["loritta.date.minute"],
            locale["loritta.date.minutes"],
            locale["loritta.date.second"],
            locale["loritta.date.seconds"]
        )
        var accuracy = 0
