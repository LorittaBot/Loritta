...
open class PlainProfileCreator(loritta: LorittaBot, internalName: String, val folderName: String) :
    ...
    class PlainGreenHeartsProfileCreator(loritta: LorittaBot) :
        PlainProfileCreator(loritta, "plainGreenHearts", "green_hearts")
    ...
    override suspend fun create(
        ...
        ProfileUtils.getMarriageInfo(loritta, userProfile)?.let { (marriage, marriedWith) ->
            ...
            ImageUtils.drawCenteredString(
                ...
                Rectangle(635, 350 + 16 + 18, 165, 14),
                latoBlack12
            )
        }
