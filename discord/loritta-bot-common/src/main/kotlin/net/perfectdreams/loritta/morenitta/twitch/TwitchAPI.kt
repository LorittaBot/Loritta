...
class TwitchAPI(
    ...
    val cachedStreamerInfo =
        Caffeine.newBuilder().expireAfterWrite(30, TimeUnit.MINUTES).maximumSize(7500).build<String, StreamerInfo>()
            .asMap()
    val cachedStreamerInfoById =
        Caffeine.newBuilder().expireAfterWrite(30, TimeUnit.MINUTES).maximumSize(7500).build<Long, StreamerInfo>()
            .asMap()
    val cachedGames =
        Caffeine.newBuilder().expireAfterWrite(8, TimeUnit.HOURS).maximumSize(1000).build<String, GameInfo>().asMap()
    ...
    suspend fun makeTwitchApiRequest(
        url: String,
        method: String = "GET",
