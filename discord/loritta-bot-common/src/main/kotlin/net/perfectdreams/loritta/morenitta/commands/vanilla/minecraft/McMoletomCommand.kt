...
class McMoletomCommand(loritta: LorittaBot) : AbstractCommand(
    loritta,
    "mcmoletom",
    listOf("mcsweater"),
    net.perfectdreams.loritta.common.commands.CommandCategory.MINECRAFT
) {
    ...
    override suspend fun run(context: CommandContext, locale: BaseLocale) {
        ...
        if (skin != null) {
            ...
            val str =
                "<:loritta:331179879582269451> **|** " + context.getAsMention(true) + locale["commands.command.mcsweater.done"]
    ...
    companion object {
        suspend fun createSkin(originalSkin: BufferedImage?): BufferedImage? {
            ...
            val template = if (isAlex) readImage(
                File(
                    LorittaBot.ASSETS,
                    "template_alex.png"
                )
            ) else readImage(File(LorittaBot.ASSETS, "template_steve.png"))
