...
class LembrarCommand(loritta: LorittaBot) : AbstractCommand(
    loritta,
    "remindme",
    listOf("lembre", "remind", "lembrar", "lembrete", "reminder"),
    ...
    private suspend fun handleReminderList(context: CommandContext, page: Int, locale: BaseLocale) {
        ...
        message.onReactionAddByAuthor(context) {
            ...
            embedBuilder.appendDescription(
                "**${locale["${LOCALE_PREFIX}.remindAt"]} ** ${
                    reminder.remindAt.humanize(
                        locale
                    )
                }\n"
            )
