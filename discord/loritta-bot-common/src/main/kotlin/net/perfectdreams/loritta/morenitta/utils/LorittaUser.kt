 ...
 */
open class LorittaUser(
    val loritta: LorittaBot,
    val user: User,
    val permissions: EnumSet<LorittaPermission>,
    ...
    companion object {
         ...
         */
        suspend fun loadGuildRolesLorittaPermissions(loritta: LorittaBot, serverConfig: ServerConfig, guild: Guild) =
         ...
         * @see loadMemberLorittaPermissions
         */
        suspend fun loadMemberRolesLorittaPermissions(loritta: LorittaBot, serverConfig: ServerConfig, member: Member) =
            loritta.newSuspendedTransaction {
                _loadMemberRolesLorittaPermissions(serverConfig, member)
            }

        private fun _loadMemberRolesLorittaPermissions(
            serverConfig: ServerConfig,
            member: Member
        ): Map<Long, EnumSet<LorittaPermission>> {
            val permissions = ServerRolePermissions.select {
         ...
         * @see loadMemberLorittaPermissions
         */
        fun convertRolePermissionsMapToMemberPermissionList(
            member: Member,
            rolePermissions: Map<Long, EnumSet<LorittaPermission>>
        ): EnumSet<LorittaPermission> {
         ...
         * @see loadMemberRolesLorittaPermissions
         */
        suspend fun loadMemberLorittaPermissions(loritta: LorittaBot, serverConfig: ServerConfig, member: Member) =
            convertRolePermissionsMapToMemberPermissionList(
                member,
 ...
 */
class GuildLorittaUser(
    loritta: LorittaBot,
    val member: Member,
    permissions: EnumSet<LorittaPermission>,
    _profile: Profile?
) : LorittaUser(loritta, member.user, permissions, _profile) {
    /**
     * Verifica se o usuário tem permissão para utilizar um comando
     */
