...
class LavaCommand(loritta: LorittaBot) :
    AbstractCommand(loritta, "lava", category = net.perfectdreams.loritta.common.commands.CommandCategory.IMAGES) {
