...
class DefaultProfileCreator(loritta: LorittaBot) : StaticProfileCreator(loritta, "modernBlurple") {
    ...
    override suspend fun create(
        ...
        val avatar = LorittaUtils.downloadImage(loritta, user.avatarUrl)!!
            .getScaledInstance(115, 115, BufferedImage.SCALE_SMOOTH)
        ...
        if (guild != null) {
            val guildIcon = LorittaUtils.downloadImage(
                loritta,
                guild.iconUrl?.replace("jpg", "png")
                    ?: "https://emojipedia-us.s3.amazonaws.com/thumbs/320/google/56/shrug_1f937.png"
            )!!.getScaledInstance(38, 38, BufferedImage.SCALE_SMOOTH)
