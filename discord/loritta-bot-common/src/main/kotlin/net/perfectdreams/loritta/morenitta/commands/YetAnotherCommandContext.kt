...
import net.perfectdreams.loritta.morenitta.entities.LorittaReply
import net.perfectdreams.loritta.common.entities.Message
import net.perfectdreams.loritta.morenitta.entities.MessageChannel
import net.perfectdreams.loritta.common.entities.User
import net.perfectdreams.loritta.common.locale.BaseLocale
import net.perfectdreams.loritta.morenitta.LorittaBot
import net.perfectdreams.loritta.morenitta.builder.ContextualMultiReplyBuilder
import net.perfectdreams.loritta.morenitta.builder.MessageBuilder

abstract class YetAnotherCommandContext(
    ...
    suspend fun sendReplies(block: ContextualMultiReplyBuilder.() -> Unit = {}) = sendMessage {
        val builder = ContextualMultiReplyBuilder(this@YetAnotherCommandContext).apply(block)
