...
class TextVaporwaveExecutor(loritta: LorittaBot) : CinnamonSlashCommandExecutor(loritta) {
    ...
    override suspend fun execute(context: ApplicationCommandContext, args: SlashCommandArguments) {
        val text = cleanUpForOutput(
            context,
            args[options.text]
        ) // We will clean up before, because after vaporwaving the text, it won't be possible to clean it up
