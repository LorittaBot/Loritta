...
class VemDeZapCommand(loritta: LorittaBot) :
    AbstractCommand(loritta, "vemdezap", category = net.perfectdreams.loritta.common.commands.CommandCategory.FUN) {
    companion object {
        private val fullMatch = mapOf(
            "100" to listOf("💯"),
            "alface" to listOf("🥗"),
            "alvo" to listOf("🎯"),
            "amo" to listOf("😍", "😻", "😘", "😗", "😙", "😚", "💘	", "❤", "💓", "💕", "💖", "💖"),
