...
class LorittaWebsite(
    ...
    init {
        ...
        ENGINE = PebbleEngine.Builder()
            .cacheActive(true) // Deixar o cache ativo ajuda na performance ao usar "extends" em templates (e não ao carregar templates de arquivos!)
            ...
            install(CachingHeaders) {
                options { call, outgoingContent ->
                    ...
                    if (contentType != null) {
                        ...
                        val matches =
                            typesToCache.any { contentTypeWithoutParameters.match(it) || contentTypeWithoutParameters == it }
