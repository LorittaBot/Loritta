...
class CancelledCommand(val m: LorittaBot) : LorittaAbstractCommandBase(
    m,
    listOf("cancelled", "cancelado", "cancel", "cancelar"),
    ...
    override fun command() = create {
        ...
        executes {
            ...
            reply(
                LorittaReply(
                    locale["commands.command.cancelled.wasCancelled", user.asMention, locale.getList("commands.command.cancelled.reasons")
                        .random()],
                    Emotes.LORI_HMPF
                )
            )
