...
class McHeadCommand(loritta: LorittaBot) :
    AbstractCommand(loritta, "mchead", category = net.perfectdreams.loritta.common.commands.CommandCategory.MINECRAFT) {
    ...
    override suspend fun run(context: CommandContext, locale: BaseLocale) {
        ...
        if (context.args.isNotEmpty()) {
            ...
            val bufferedImage =
                LorittaUtils.downloadImage(loritta, "https://crafatar.com/renders/head/$uuid?size=128&overlay")
