...
class ScratchCardCommand(loritta: LorittaBot) : DiscordAbstractCommandBase(
    loritta,
    listOf("scratchcard", "raspadinha"),
        ...
        executesDiscord {
            ...
            if (context.args.firstOrNull() == "ganhar" || context.args.firstOrNull() == "win" || context.args.firstOrNull() == "claim") {
                ...
                context.reply(
                    ...
                    LorittaReply(
                        "Você já comprou **${raspadinhaCount} raspadinhas** e, com elas, você ganhou **${
                            raspadinhaEarnings?.get(
                                earnings
                            ) ?: 0
                        } sonhos**",
                        mentionUser = false
    ...
    private suspend fun buyRaspadinha(
        context: DiscordCommandContext,
        profile: Profile,
        message: Message? = null,
        _boughtScratchCardsInThisMessage: Int = 0
    ) {
        ...
        mutex.withLock {
            ...
            val scratchCardTemplate =
                """<:scratch_01:664139718279168002><:scratch_02:664139717889097739><:scratch_03:664139718161596416><:scratch_04:664139718329630721><:scratch_05:664139718304464896><:scratch_06:664139718132236318>
<:scratch_07:664139718337888266>||${transformToEmote(array[0][0])}||||${transformToEmote(array[1][0])}||||${
                    transformToEmote(array[2][0])
                }||<:scratch_11:664139718220316702><:scratch_12:664139718220316685>
<:scratch_13:664139718308397076>||${transformToEmote(array[0][1])}||||${transformToEmote(array[1][1])}||||${
                    transformToEmote(
                        array[2][1]
                    )
                }||<:scratch_17:664139718321242134><:scratch_18:664139718123978763>
<:scratch_19:664139718140755986>||${transformToEmote(array[0][2])}||||${transformToEmote(array[1][2])}||||${
                    transformToEmote(
                        array[2][2]
                    )
                }||<:scratch_23:664139718266716160><:scratch_24:664139718354665492> 
<:scratch_25:664139718354796545><:scratch_26:664139718014795779><:scratch_27:664139718237224981><:scratch_28:664139718388351007><:scratch_29:664139718430162954><:scratch_30:664139717989629968>"""
            ...
            val theMessage =
                message?.edit(MessageBuilder().append(contentWithInvisibleSpoilers).build(), clearReactions = false)
                    ?: context.discordMessage.channel.sendMessage(contentWithInvisibleSpoilers)
