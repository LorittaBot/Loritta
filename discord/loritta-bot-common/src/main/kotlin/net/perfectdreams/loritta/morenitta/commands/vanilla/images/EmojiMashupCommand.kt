...
open class EmojiMashupCommand(loritta: LorittaBot) : DiscordAbstractCommandBase(
    loritta,
    listOf("emojimashup", "emojismashup", "mashupemoji", "mashupemojis", "misturaremojis", "misturaremoji"),
