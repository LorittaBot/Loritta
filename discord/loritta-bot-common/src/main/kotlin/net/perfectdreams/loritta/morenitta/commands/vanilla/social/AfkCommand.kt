...
class AfkCommand(loritta: LorittaBot) : AbstractCommand(
    loritta,
    "afk",
    listOf("awayfromthekeyboard"),
    ...
    override suspend fun run(context: CommandContext, locale: BaseLocale) {
        ...
        if (profile.isAfk) {
            ...
            val reason =
                context.args.joinToString(" ").stripNewLines().stripCodeMarks().substringIfNeeded(range = 0..299)
