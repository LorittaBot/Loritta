...
class RepTopCommand(loritta: LorittaBot) : DiscordAbstractCommandBase(
    loritta,
    ...
    override fun command() = create {
        ...
        executesDiscord {
            ...
            val type =
                if (typeName in loritta.localeManager.locales.map { locale["commands.command.topreputation.given"].toLowerCase() }
                        .distinct())
                    TopOrder.MOST_GIVEN
                else
