...
class TriggeredCommand(loritta: LorittaBot) :
    AbstractCommand(loritta, "triggered", category = net.perfectdreams.loritta.common.commands.CommandCategory.IMAGES) {
    ...
    override suspend fun run(context: CommandContext, locale: BaseLocale) {
        ...
        val base =
            BufferedImage(inputWidth, inputHeight + scaledTriggeredLabel.getHeight(null), BufferedImage.TYPE_INT_ARGB)
