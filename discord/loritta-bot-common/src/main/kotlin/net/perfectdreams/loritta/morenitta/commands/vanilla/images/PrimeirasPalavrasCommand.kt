...
class PrimeirasPalavrasCommand(loritta: LorittaBot) : AbstractCommand(
    loritta,
    "firstwords",
    listOf("primeiraspalavras"),
    ...
    override suspend fun run(context: CommandContext, locale: BaseLocale) {
        if (context.args.isNotEmpty()) {
            ...
            val bi =
                readImage(File(LorittaBot.ASSETS + "tirinha_baby.png")) // Primeiro iremos carregar o nosso template
