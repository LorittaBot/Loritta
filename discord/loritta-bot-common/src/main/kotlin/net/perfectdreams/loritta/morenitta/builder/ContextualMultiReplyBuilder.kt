...
import net.perfectdreams.loritta.morenitta.commands.YetAnotherCommandContext
...
class ContextualMultiReplyBuilder(private val context: YetAnotherCommandContext) {
