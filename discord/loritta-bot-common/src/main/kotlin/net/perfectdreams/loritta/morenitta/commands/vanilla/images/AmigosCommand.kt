...
class AmigosCommand(loritta: LorittaBot) : AbstractCommand(
    loritta,
    "friends",
    listOf("amigos", "meusamigos", "myfriends"),
    ...
    override suspend fun run(context: CommandContext, locale: BaseLocale) {
        ...
        var contextImage =
            context.getImageAt(0, 0, 128, createTextAsImageIfNotFound = false) ?: getRandomAvatar(context, choosen)
        var contextImage2 =
            context.getImageAt(1, 0, 128, createTextAsImageIfNotFound = false) ?: getRandomAvatar(context, choosen)
        var contextImage3 =
            context.getImageAt(2, 0, 128, createTextAsImageIfNotFound = false) ?: getRandomAvatar(context, choosen)
        var contextImage4 =
            context.getImageAt(3, 0, 128, createTextAsImageIfNotFound = false) ?: getRandomAvatar(context, choosen)
        var contextImage5 =
            context.getImageAt(4, 0, 128, createTextAsImageIfNotFound = false) ?: getRandomAvatar(context, choosen)
        var contextImage6 =
            context.getImageAt(5, 0, 128, createTextAsImageIfNotFound = false) ?: getRandomAvatar(context, choosen)
        var contextImage7 =
            context.getImageAt(6, 0, 128, createTextAsImageIfNotFound = false) ?: getRandomAvatar(context, choosen)
        var contextImage8 =
            context.getImageAt(7, 0, 128, createTextAsImageIfNotFound = false) ?: getRandomAvatar(context, choosen)
        var contextImage9 =
            context.getImageAt(8, 0, 128, createTextAsImageIfNotFound = false) ?: getRandomAvatar(context, choosen)
