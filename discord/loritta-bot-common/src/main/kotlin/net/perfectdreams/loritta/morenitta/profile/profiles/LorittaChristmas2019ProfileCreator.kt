...
class LorittaChristmas2019ProfileCreator(loritta: LorittaBot) :
    AnimatedProfileCreator(loritta, "lorittaChristmas2019") {
    override suspend fun create(
        ...
        for (i in 0..7) {
            val profileWrapper = readImage(
                File(
                    LorittaBot.ASSETS,
                    "profile/christmas_2019/frames/christmas_2019_${i.toString().padStart(6, '0')}.png"
                )
            )
            ...
            val biggestStrWidth = drawUserInfo(
                user,
                userProfile,
                guild,
                graphics,
