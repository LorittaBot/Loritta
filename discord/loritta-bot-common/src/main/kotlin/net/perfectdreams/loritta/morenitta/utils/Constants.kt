...
object Constants {
    ...
    val HTTP_URL_PATTERN =
        Pattern.compile("https?:\\/\\/[-a-zA-Z0-9@:%._+~#=]{2,256}\\.[A-z]{2,7}\\b([-a-zA-Z0-9@:%_+.~#?&/=]*)")
    ...
    val DISCORD_INVITE_PATTERN = Pattern.compile(
        ".*(discord\\.gg|(?:discordapp.com|discord.com)(?:/invite))/([A-z0-9]+).*",
