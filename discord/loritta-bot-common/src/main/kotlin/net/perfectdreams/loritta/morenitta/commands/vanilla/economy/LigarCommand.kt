...
class LigarCommand(loritta: LorittaBot) :
    AbstractCommand(loritta, "ligar", category = net.perfectdreams.loritta.common.commands.CommandCategory.ECONOMY) {
    companion object {
            ...
            if (phoneNumber == "40028922") {
                ...
                GlobalScope.launch(coroutineExecutor) {
                    if (loritta.bomDiaECia.available) {
                        ...
                        loritta.bomDiaECia.announceWinner(
