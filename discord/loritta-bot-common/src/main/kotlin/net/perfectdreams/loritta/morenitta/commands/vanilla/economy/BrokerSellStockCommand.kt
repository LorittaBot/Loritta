...
class BrokerSellStockCommand(loritta: LorittaBot) : DiscordAbstractCommandBase(loritta, BrokerCommand.ALIASES.flatMap { listOf("$it sell", "$it vender") }, net.perfectdreams.loritta.common.commands.CommandCategory.ECONOMY) {
	companion object {
