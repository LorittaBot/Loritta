...
class SonhosCommand(loritta: LorittaBot) : AbstractCommand(
    loritta,
    "sonhos",
    listOf("atm", "bal", "balance"),
    category = net.perfectdreams.loritta.common.commands.CommandCategory.ECONOMY
) {
