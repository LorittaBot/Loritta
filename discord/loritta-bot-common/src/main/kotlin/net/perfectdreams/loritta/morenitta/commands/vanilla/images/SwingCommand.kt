...
class SwingCommand(loritta: LorittaBot) :
    AbstractCommand(loritta, "swing", category = net.perfectdreams.loritta.common.commands.CommandCategory.IMAGES) {
    ...
    override suspend fun run(context: CommandContext, locale: BaseLocale) {
        ...
        val contextImage2 = context.getImageAt(1, search = 0) ?: LorittaUtils.downloadImage(
            loritta,
            context.userHandle.effectiveAvatarUrl
        ) ?: run { Constants.INVALID_IMAGE_REPLY.invoke(context); return; }
