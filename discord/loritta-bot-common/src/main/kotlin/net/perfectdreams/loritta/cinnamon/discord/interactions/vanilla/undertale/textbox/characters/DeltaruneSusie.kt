...
object DeltaruneSusie : CharacterData() {
    override fun menuOptions(i18nContext: I18nContext, activePortrait: String, builder: SelectMenuBuilder) {
        ...
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.Angry),
            "deltarune/susie/angry3",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.Blushing),
            "deltarune/susie/blushing",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.Concerned),
            "deltarune/susie/concerned",
            activePortrait
        )
        ...
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.GrinClosedEyes),
            "deltarune/susie/grin_closed_eyes",
            activePortrait
        )
        ...
        builder.optionAndAutomaticallySetDefault(
            ...
            "deltarune/susie/happy",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.LookingDown),
            "deltarune/susie/looking_down",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.Pissed),
            "deltarune/susie/pissed",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.RalseiGlasses),
            "deltarune/susie/ralsei_glasses",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
        ...
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.Scary),
            "deltarune/susie/scary",
            activePortrait
        )
        ...
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.Smiling),
            "deltarune/susie/smiling",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.SmilingClosedEyes),
            "deltarune/susie/smiling_closed_eyes",
            activePortrait
        )
        ...
        builder.optionAndAutomaticallySetDefault(
            ...
            "deltarune/susie/surprised",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.SurprisedGrin),
            "deltarune/susie/surprised_grin",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.SurprisedSmile),
            "deltarune/susie/surprised_smile",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.Suspicious),
            "deltarune/susie/suspicious",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.SuspiciousGrin),
            "deltarune/susie/suspicious_grin",
            activePortrait
        )
        ...
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.SuspiciousLookingAwaySweating),
            "deltarune/susie/suspicious_looking_away_sweating",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.SuspiciousSmiling),
            "deltarune/susie/suspicious_smiling",
            activePortrait
        )
        ...
        builder.optionAndAutomaticallySetDefault(
            ...
            "deltarune/susie/uhhh",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.UhhhSmiling),
            "deltarune/susie/uhhh_happy",
            activePortrait
        )
    }
}