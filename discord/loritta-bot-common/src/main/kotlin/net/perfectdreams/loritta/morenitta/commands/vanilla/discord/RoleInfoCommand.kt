    ...
    override fun command() = create {
        ...
        executesDiscord {
            ...
            if (role != null) {
                ...
                builder.addField("\uD83D\uDCC5 ${locale["$LOCALE_PREFIX.roleinfo.roleCreated"]}", DateUtils.formatDateWithRelativeFromNowAndAbsoluteDifferenceWithDiscordMarkdown(role.timeCreated), true)
