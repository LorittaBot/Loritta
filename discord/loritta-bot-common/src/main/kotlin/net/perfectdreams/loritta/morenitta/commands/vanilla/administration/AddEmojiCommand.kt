...
class AddEmojiCommand(loritta: LorittaBot) : AbstractCommand(
    loritta,
    "addemoji",
    listOf("adicionaremoji", "createemoji", "criaremoji"),
    ...
    override suspend fun run(context: CommandContext, locale: BaseLocale) {
        ...
        val imageUrl =
            context.getImageUrlAt(imageArgument, 1) ?: run { Constants.INVALID_IMAGE_REPLY.invoke(context); return; }
