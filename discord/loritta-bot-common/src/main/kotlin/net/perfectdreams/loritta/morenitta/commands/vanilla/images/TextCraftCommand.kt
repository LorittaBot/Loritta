...
class TextCraftCommand(loritta: LorittaBot) :
    AbstractCommand(loritta, "textcraft", category = net.perfectdreams.loritta.common.commands.CommandCategory.IMAGES) {
