...
class PatreonCommand(loritta: LorittaBot) : AbstractCommand(
    loritta,
    "donator",
    listOf(
        "donators",
    ...
    override suspend fun run(context: CommandContext, locale: BaseLocale) {
        val patrons =
            "Veja todos os doadores em https://loritta.website/donate (tem tantos doadores que não cabe nesta mensagem! ${Emotes.LORI_CRYING})"
        ...
        val embed = EmbedBuilder().apply {
            ...
            addField(
                "\uD83C\uDF80 " + context.locale["commands.command.donate.doYouWannaHelp"],
                context.locale["commands.command.donate.howToHelp", "${loritta.config.loritta.website.url}donate", Emotes.LORI_HEART, Emotes.LORI_CRYING, Emotes.LORI_RICH],
                false
            )
        }
