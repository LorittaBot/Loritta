...
class ConfigureMiscellaneousRoute(loritta: LorittaBot) :
    GenericConfigurationRoute(loritta, "/configure/miscellaneous", "miscellaneous", "configure_miscellaneous.html") {
    /**
