...
class RipVidaCommand(loritta: LorittaBot) : AbstractCommand(
    loritta,
    "riplife",
    listOf("ripvida"),
    ...
    override suspend fun run(context: CommandContext, locale: BaseLocale) {
        ...
        val template = readImage(File(LorittaBot.ASSETS + context.locale["commands.command.ripvida.file"])) // Template
