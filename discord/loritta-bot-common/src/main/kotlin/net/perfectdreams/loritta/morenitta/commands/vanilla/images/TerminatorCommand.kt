        ...
        executes {
            ...
            fun drawTextCentralizedNewLines(text: String, startAtX: Int, startAtY: Int) {
                ...
                for (split in splitInput1) {
                    ...
                    if (0 >= startAtX - (graphics.getFontMetrics(font)
                            .stringWidth(input1FitInLine) / 2) || startAtX + (graphics.getFontMetrics(font)
                            .stringWidth(input1FitInLine) / 2) >= terminatorAnime.width
                    ) {
