...
object KnucklesThrowGIF {
    fun getGIF(_toUse: BufferedImage): File {
        ...
        for (i in 0..61) {
            ...
            if (file.exists()) {
                val ogImage =
                    ImageIO.read(File(LorittaBot.ASSETS, "knux_throw/knuxthrow_${i.toString().padStart(6, '0')}.png"))
                ...
                val overlayFile =
                    File(LorittaBot.ASSETS, "knux_throw/knuxthrow_overlay_${i.toString().padStart(6, '0')}.png")
