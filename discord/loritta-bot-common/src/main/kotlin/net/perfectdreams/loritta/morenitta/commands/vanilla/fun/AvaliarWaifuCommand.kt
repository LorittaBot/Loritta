...
class AvaliarWaifuCommand(loritta: LorittaBot) : AbstractCommand(
    loritta,
    "ratewaifu",
    listOf("avaliarwaifu", "ratemywaifu", "ratewaifu", "avaliarminhawaifu", "notawaifu"),
    ...
    override suspend fun run(context: CommandContext, locale: BaseLocale) {
        ...
        if (context.args.isNotEmpty()) {
            ...
            val random = SplittableRandom(
                Calendar.getInstance(TimeZone.getTimeZone(Constants.LORITTA_TIMEZONE))
                    .get(Calendar.DAY_OF_YEAR) + waifuLowerCase.hashCode().toLong()
            ) // Usar um RANDOM sempre com a mesma seed
