...
object UndertaleUndyne : CharacterData() {
    override fun menuOptions(i18nContext: I18nContext, activePortrait: String, builder: SelectMenuBuilder) {
        ...
        builder.optionAndAutomaticallySetDefault(
            ...
            "undertale/undyne/blushing",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.Defeated),
            "undertale/undyne/defeated",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.Disgusted),
            "undertale/undyne/disgusted",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.Happy),
            "undertale/undyne/happy",
            activePortrait
        )
        ...
        builder.optionAndAutomaticallySetDefault(
            ...
            "undertale/undyne_the_undying/sad",
            activePortrait
        )
        ...
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.Sweating),
            "undertale/undyne_the_undying/sweating",
            activePortrait
        )
