...
object DeltaruneNoelle : CharacterData() {
    override fun menuOptions(i18nContext: I18nContext, activePortrait: String, builder: SelectMenuBuilder) {
        ...
        builder.optionAndAutomaticallySetDefault(
            ...
            "deltarune/noelle/angry",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.Anxious),
            "deltarune/noelle/anxious",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.Anxious),
            "deltarune/noelle/anxious2",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.Anxious),
            "deltarune/noelle/anxious3",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.AnxiousLookingAway),
            "deltarune/noelle/anxious_looking_away",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.Blushing),
            "deltarune/noelle/blushing",
            activePortrait
        )
        ...
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.Fear),
            "deltarune/noelle/fear",
            activePortrait
        )
        ...
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.Flustered),
            "deltarune/noelle/flustered",
            activePortrait
        )
        ...
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.Laughing),
            "deltarune/noelle/laughing",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.Melancholy),
            "deltarune/noelle/melancholy",
            activePortrait
        )
        ...
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.Mischievous),
            "deltarune/noelle/mischievous2",
            activePortrait
        )
        ...
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.Relieved),
            "deltarune/noelle/relieved",
            activePortrait
        )
        ...
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.RelievedEyesClosed),
            "deltarune/noelle/relieved_eyes_closed",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.Sad),
            "deltarune/noelle/sad",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.SadLookingDown),
            "deltarune/noelle/sad_looking_down",
            activePortrait
        )
        ...
        builder.optionAndAutomaticallySetDefault(
            ...
            "deltarune/noelle/serious2",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.Serious),
            "deltarune/noelle/serious3",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.SeriousLookingAway),
            "deltarune/noelle/serious_looking_away",
            activePortrait
        )
        ...
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.Shy),
            "deltarune/noelle/shy",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.Smiling),
            "deltarune/noelle/smiling",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.Spooked),
            "deltarune/noelle/spooked",
            activePortrait
        )
        ...
        builder.optionAndAutomaticallySetDefault(
            ...
            "deltarune/noelle/uhhh",
            activePortrait
        )
        builder.optionAndAutomaticallySetDefault(
            i18nContext.get(UndertaleCommand.I18N_TEXTBOX_PREFIX.Portraits.WhatWhatWhatWhatWhatWhat),
            "deltarune/noelle/what_what_what_what_what_what",
            activePortrait
        )
    }
}