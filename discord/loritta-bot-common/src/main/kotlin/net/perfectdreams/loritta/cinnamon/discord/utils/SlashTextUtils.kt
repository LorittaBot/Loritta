...
object SlashTextUtils {
    fun shorten(languageManager: LanguageManager, i18nData: StringI18nData) =
        shorten(languageManager.defaultI18nContext.get(i18nData))
    ...
    fun buildDescription(i18nContext: I18nContext, description: StringI18nData, category: CommandCategory) =
        buildString {
            // It looks like this
     ...
     */
    fun createLocalizedStringMapExcludingDefaultLocale(languageManager: LanguageManager, key: StringI18nData) =
     ...
     * @param i18nKey the key
     */
    fun createLocalizedDescriptionMapExcludingDefaultLocale(
     ...
     * @param i18nKey the key
     */
    fun createShortenedLocalizedDescriptionMapExcludingDefaultLocale(
        languageManager: LanguageManager,
        description: StringI18nData,
        category: CommandCategory
