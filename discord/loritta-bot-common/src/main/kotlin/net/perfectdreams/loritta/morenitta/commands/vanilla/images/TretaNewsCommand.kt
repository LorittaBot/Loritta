...
class TretaNewsCommand(loritta: LorittaBot) :
    AbstractCommand(loritta, "tretanews", category = net.perfectdreams.loritta.common.commands.CommandCategory.FUN) {
