...
class UserAvatarUserCommand(loritta: LorittaCinnamon) : CinnamonUserCommandDeclarationWrapper(loritta) {
    val I18N_PREFIX = I18nKeysData.Commands.Command.User

    override fun declaration() = userCommand(I18N_PREFIX.Avatar.ViewAvatar, UserAvatarUserExecutor(loritta))
}