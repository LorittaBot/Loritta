...
class PepeDreamCommand(loritta: LorittaCinnamon, val gabiClient: GabrielaImageServerClient) : CinnamonSlashCommandDeclarationWrapper(loritta) {
    companion object {
    ...
    override fun declaration() = slashCommand("pepedream", CommandCategory.IMAGES, I18N_PREFIX.Description) {
        executor = PepeDreamExecutor(loritta, gabiClient)
    }
}