...
class TrumpCommand(loritta: LorittaCinnamon, val gabiClient: GabrielaImageServerClient) : CinnamonSlashCommandDeclarationWrapper(loritta) {
    companion object {
    ...
    override fun declaration() = slashCommand("trump", CommandCategory.IMAGES, I18N_PREFIX.Description) {
        executor = TrumpExecutor(loritta, gabiClient)
    }
}