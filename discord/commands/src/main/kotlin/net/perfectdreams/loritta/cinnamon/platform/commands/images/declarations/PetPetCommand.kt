...
class PetPetCommand(loritta: LorittaCinnamon, val gabiClient: GabrielaImageServerClient) : CinnamonSlashCommandDeclarationWrapper(loritta) {
    companion object {
    ...
    override fun declaration() = slashCommand("petpet", CommandCategory.IMAGES, I18N_PREFIX.Description) {
        executor = PetPetExecutor(loritta, gabiClient)
    }
}