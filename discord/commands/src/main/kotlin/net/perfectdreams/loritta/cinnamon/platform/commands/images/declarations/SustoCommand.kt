...
class SustoCommand(loritta: LorittaCinnamon, val gabiClient: GabrielaImageServerClient) : CinnamonSlashCommandDeclarationWrapper(loritta) {
    companion object {
    ...
    override fun declaration() = slashCommand("scared", CommandCategory.IMAGES, I18N_PREFIX.Description) {
        executor = SustoExecutor(loritta, gabiClient)
    }
}