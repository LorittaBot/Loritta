...
class RipTvCommand(loritta: LorittaCinnamon, val gabiClient: GabrielaImageServerClient) : CinnamonSlashCommandDeclarationWrapper(loritta) {
    companion object {
    ...
    override fun declaration() = slashCommand("riptv", CommandCategory.IMAGES, I18N_PREFIX.Description) {
        executor = RipTvExecutor(loritta, gabiClient)
    }
}