...
class ShipCommand(loritta: LorittaCinnamon, val gabiClient: GabrielaImageServerClient) : CinnamonSlashCommandDeclarationWrapper(loritta) {
    companion object {
    ...
    override fun declaration() = slashCommand("ship", CommandCategory.FUN, I18N_PREFIX.Description) {
        executor = ShipExecutor(loritta, gabiClient)
    }
}