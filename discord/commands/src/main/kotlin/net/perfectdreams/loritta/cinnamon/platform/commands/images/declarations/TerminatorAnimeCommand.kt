...
class TerminatorAnimeCommand(loritta: LorittaCinnamon, val gabiClient: GabrielaImageServerClient) : CinnamonSlashCommandDeclarationWrapper(loritta) {
    companion object {
    ...
    override fun declaration() = slashCommand("terminatoranime", CommandCategory.IMAGES, I18N_PREFIX.Description) {
        executor = TerminatorAnimeExecutor(loritta, gabiClient)
    }
}