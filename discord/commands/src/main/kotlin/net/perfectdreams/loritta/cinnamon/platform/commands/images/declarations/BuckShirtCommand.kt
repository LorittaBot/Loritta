...
class BuckShirtCommand(loritta: LorittaCinnamon, val gabiClient: GabrielaImageServerClient) : CinnamonSlashCommandDeclarationWrapper(loritta) {
    companion object {
    ...
    override fun declaration() = slashCommand("buckshirt", CommandCategory.IMAGES, I18N_PREFIX.Description) {
        executor = BuckShirtExecutor(loritta, gabiClient)
    }
}