...
class PetPetExecutor(val client: GabrielaImageServerClient) : CommandExecutor() {
    companion object : CommandExecutorDeclaration(PetPetExecutor::class) {
        object Options : CommandOptions() {
            ...
            val squish = optionalNumber("squish", PetPetCommand.I18N_PREFIX.Options.Squish.Text)
                ...
                .choice(3.0, PetPetCommand.I18N_PREFIX.Options.Squish.Choice.PatItSoTheyCanFeelIt)
                .register()
