...
class WebhookSendSimpleExecutor(val rest: RestClient) : SlashCommandExecutor() {
    companion object : SlashCommandExecutorDeclaration(WebhookSendSimpleExecutor::class) {
