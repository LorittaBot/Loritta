...
class ServerIconExecutor(val rest: RestClient) : CommandExecutor() {
    companion object : CommandExecutorDeclaration(ServerIconExecutor::class)

    override suspend fun execute(context: ApplicationCommandContext, args: CommandArguments) {
        if (context.interaKTionsContext !is GuildApplicationCommandContext) throw CommandException {
