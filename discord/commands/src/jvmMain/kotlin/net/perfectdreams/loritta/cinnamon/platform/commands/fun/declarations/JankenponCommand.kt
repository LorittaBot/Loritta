...
object JankenponCommand: SlashCommandDeclarationWrapper {
    ...
    override fun declaration(): SlashCommandDeclarationBuilder = slashCommand(listOf("jankenpon", "pedrapapeltesoura", "ppt"), CommandCategory.FUN, I18N_PREFIX.Description) {
