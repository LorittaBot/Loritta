...
) : RetributePictureExecutor(client, { gender1, gender2 -> client.highFive(gender1, gender2) }, Companion) {
    companion object : ButtonClickExecutorDeclaration(
        RetributeHighFiveButtonExecutor::class,
        ComponentExecutorIds.RETRIBUTE_HIGH_FIVE_BUTTON_EXECUTOR
    )
}