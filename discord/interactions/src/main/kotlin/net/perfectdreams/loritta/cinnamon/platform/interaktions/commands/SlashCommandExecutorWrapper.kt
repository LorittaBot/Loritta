...
import net.perfectdreams.loritta.cinnamon.common.commands.CommandException
import net.perfectdreams.loritta.cinnamon.common.commands.CommandExecutor
import net.perfectdreams.loritta.cinnamon.common.commands.SilentCommandException
...
import net.perfectdreams.loritta.cinnamon.platform.interaktions.entities.InteraKTionsUser
import net.perfectdreams.loritta.cinnamon.platform.interaktions.utils.metrics.Prometheus
...
class SlashCommandExecutorWrapper(
    ...
    override suspend fun execute(context: ApplicationCommandContext, args: SlashCommandArguments) {
        ...
        val channel = InteraKTionsInteractionMessageChannel(context)
        ...
        try {
            ...
            cinnamonContext = InteraKTionsCommandContext(
                loritta,
                i18nContext,
