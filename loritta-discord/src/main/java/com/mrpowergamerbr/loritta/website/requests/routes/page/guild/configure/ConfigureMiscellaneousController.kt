...
@Path("/:localeId/guild/:guildId/configure/miscellaneous")
class ConfigureMiscellaneousController {
	@GET
	...
	fun handle(req: Request, res: Response, @Local variables: MutableMap<String, Any?>): String {
		variables["saveType"] = "miscellaneous"
		return evaluate("configure_miscellaneous.html", variables)
	}
}