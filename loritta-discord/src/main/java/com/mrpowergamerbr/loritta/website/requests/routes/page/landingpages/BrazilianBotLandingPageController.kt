package com.mrpowergamerbr.loritta.website.requests.routes.page.landingpages
...
@Path("/:localeId/discord-bot-brasileiro")
class BrazilianBotLandingPageController {
	@GET
