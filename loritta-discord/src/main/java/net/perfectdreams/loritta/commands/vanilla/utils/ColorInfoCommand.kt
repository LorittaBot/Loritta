...
class ColorInfoCommand(loritta: LorittaDiscord) : DiscordAbstractCommandBase(loritta, listOf("colorinfo", "rgb", "hexcolor", "hex", "colorpick", "colorpicker"), CommandCategory.UTILS) {
	companion object {
	...
	override fun command() = create {
		...
		executesDiscord {
			...
			if (context.args.isNotEmpty()) {
				...
				discordMessage.textChannel.sendMessage(embed.build()).addFile(JVMImage(colorInfo).toByteArray(), "color.png").queue()
			} else {
				explain()
			}
		}
