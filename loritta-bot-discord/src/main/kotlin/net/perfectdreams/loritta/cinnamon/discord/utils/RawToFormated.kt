...
object RawToFormated {
    ...
    val permissionsRepository = hashMapOf(
        ...
        Permission.ManageEmojisAndStickers to I18nKeys.Permissions.ManageEmojisAndStickers,
        Permission.UseApplicationCommands to I18nKeys.Permissions.UseApplicationCommands,
