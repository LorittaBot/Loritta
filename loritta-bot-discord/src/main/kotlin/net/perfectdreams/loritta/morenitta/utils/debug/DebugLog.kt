...
object DebugLog {
	...
	fun showExtendedInfo(loritta: LorittaBot) {
		...
		logger.info("loritta.twitch.cachedGames: ${loritta.switchTwitch.cachedGames.size}")
		logger.info("loritta.twitch.cachedStreamerInfo: ${loritta.switchTwitch.cachedStreamerInfo.size}")
		logger.info("gameInfoCache.size: ${loritta.switchTwitch.cachedGames.size}")
