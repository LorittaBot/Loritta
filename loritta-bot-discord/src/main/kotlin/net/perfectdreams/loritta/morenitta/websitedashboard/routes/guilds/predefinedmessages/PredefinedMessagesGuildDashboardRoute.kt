...
class PredefinedMessagesGuildDashboardRoute(website: LorittaDashboardWebServer) : RequiresGuildAuthDashboardLocalizedRoute(website, "/predefined-messages") {
    override suspend fun onAuthenticatedGuildRequest(call: ApplicationCall, i18nContext: I18nContext, session: LorittaUserSession, userPremiumPlan: UserPremiumPlan, theme: ColorTheme, shimejiSettings: LorittaShimejiSettings, guild: Guild, guildPremiumPlan: ServerPremiumPlan, member: Member) {
        val predefinedMessages = website.loritta.transaction {
        ...
        call.respondHtml {
            dashboardBase(
                i18nContext,
                i18nContext.get(DashboardI18nKeysData.PredefinedMessages.Title),
                session,
                theme,
                shimejiSettings,
                userPremiumPlan,
                ...
                },
                {
                    heroWrapper {
                        heroText {
                            ...
                            p {
                                handleI18nString(
                                    i18nContext,
                                    I18nKeys.Website.Dashboard.PredefinedMessages.Description,
                    ...
                    div {
                        ...
                        predefinedMessagesSection(i18nContext, guild, predefinedMessages)
                    }
                }
            )
        }
