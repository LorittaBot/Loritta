...
class GetUserTransactionsRoute(m: LorittaBot) : LoriPublicAPIRoute(
    ...
    private fun convertToPublicTransactions(transactions: List<net.perfectdreams.loritta.serializable.SonhosTransaction>): List<SonhosTransaction> {
        return transactions.map { transaction ->
            when (transaction) {
                ...
                is net.perfectdreams.loritta.serializable.APIInitiatedPaymentSonhosTransaction -> APIInitiatedPaymentSonhosTransaction(
                    transaction.id,
                    transaction.transactionType,
                    transaction.timestamp,
                    transaction.user,
                ...
                is net.perfectdreams.loritta.serializable.ThirdPartyPaymentSonhosTransaction -> ThirdPartyPaymentSonhosTransaction(
                    transaction.id,
                    transaction.transactionType,
                    transaction.timestamp,
                    transaction.user,
                ...
                is net.perfectdreams.loritta.serializable.FinishedCollectionSonhosTransaction -> FinishedCollectionSonhosTransaction(
                    transaction.id,
                    transaction.transactionType,
                    transaction.timestamp,
                    transaction.user,
                ...
                is net.perfectdreams.loritta.serializable.LorittaItemShopComissionBackgroundTransaction -> LorittaItemShopComissionProfileDesignTransaction(
                    transaction.id,
                    transaction.transactionType,
                    transaction.timestamp,
                    transaction.user,
                ...
                is net.perfectdreams.loritta.serializable.LorittaItemShopComissionProfileDesignTransaction -> LorittaItemShopComissionProfileDesignTransaction(
                    transaction.id,
                    transaction.transactionType,
                    transaction.timestamp,
                    transaction.user,
                ...
                is net.perfectdreams.loritta.serializable.MarriageMarryTransaction -> MarriageMarryTransaction(
                    transaction.id,
                    transaction.transactionType,
                    transaction.timestamp,
                    transaction.user,
                ...
                is ReputationDeletedTransaction -> ReputationDeletedLeaveTransaction(
                    transaction.id,
                    transaction.transactionType,
                    transaction.timestamp,
                    transaction.user,
                ...
                is net.perfectdreams.loritta.serializable.DropChatTransaction -> DropChatTransaction(
                    transaction.id,
                    transaction.transactionType,
                    transaction.timestamp,
                    transaction.user,
                ...
                is net.perfectdreams.loritta.serializable.DropCallTransaction -> DropCallTransaction(
                    transaction.id,
                    transaction.transactionType,
                    transaction.timestamp,
                    transaction.user,
    ...
    @Serializable
    data class FinishedCollectionSonhosTransaction(
        override val id: Long,
        override val transactionType: TransactionType,
        override val timestamp: kotlinx.datetime.Instant,
        @Serializable(UserIdAsStringSerializer::class)
    ...
    @Serializable
    data class ReputationDeletedLeaveTransaction(
        override val id: Long,
        override val transactionType: TransactionType,
        override val timestamp: kotlinx.datetime.Instant,
        @Serializable(UserIdAsStringSerializer::class)
