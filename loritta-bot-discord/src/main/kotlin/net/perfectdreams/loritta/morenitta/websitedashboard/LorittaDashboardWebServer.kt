...
import net.perfectdreams.loritta.morenitta.websitedashboard.routes.guilds.taxbox.PutTaxBoxGuildDashboardRoute
import net.perfectdreams.loritta.morenitta.websitedashboard.routes.guilds.taxbox.TaxBoxGuildDashboardRoute
...
class LorittaDashboardWebServer(val loritta: LorittaBot) {
    ...
    val dashboardRoutes = listOf(
        ...
        // Tax Box
        TaxBoxGuildDashboardRoute(this),
        PutTaxBoxGuildDashboardRoute(this),
