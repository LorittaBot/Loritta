...
class LorittaBot(
    ...
    companion object {
        ...
        const val SCHEMA_VERSION = 128 // Bump this every time any table is added/updated!
    }
    ...
    val partnerApplicationInteractionsListener = PartnerApplicationInteractionsListener(this)
    val trackGuildsListener = TrackGuildsListener(this)
    ...
    init {
        ...
        builder = DefaultShardManagerBuilder.create(
            ...
            .addEventListeners(
                ...
                partnerApplicationInteractionsListener,
                trackGuildsListener
            )
