...
object Halloween2025ReactionEvent : ReactionEvent() {
    ...
    override fun createCraftMultipleItemsButtonMessage(i18nContext: I18nContext) = TextAndEmoji(
        i18nContext.get(I18nKeysData.ReactionEvents.Event.Halloween2025.CraftItemMultiple),
        pumpkin
    )
    ...
    override fun createYouCraftedItemsMessage(i18nContext: I18nContext, quantity: Int, combo: Int): TextAndEmoji {
        return if (combo >= 3) {
            TextAndEmoji(
                i18nContext.get(I18nKeysData.ReactionEvents.Event.Halloween2025.YouCraftedItemsCombo(quantity, combo)),
                LorittaEmojiReference.UnicodeEmoji("\uD83D\uDD25"),
            )
        } else {
            TextAndEmoji(
                i18nContext.get(I18nKeysData.ReactionEvents.Event.Halloween2025.YouCraftedItems(quantity)),
                pumpkin
            )
        }
    }
