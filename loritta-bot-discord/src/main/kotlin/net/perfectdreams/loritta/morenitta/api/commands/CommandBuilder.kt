...
import net.perfectdreams.loritta.common.commands.CommandArgumentsBuilder
...
fun command(loritta: LorittaBot, commandName: String, labels: List<String>, category: net.perfectdreams.loritta.common.commands.CommandCategory, builder: CommandBuilder<CommandContext>.() -> (Unit)): Command<CommandContext> {
