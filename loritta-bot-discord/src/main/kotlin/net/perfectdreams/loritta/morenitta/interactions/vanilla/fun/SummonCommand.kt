...
class SummonCommand : SlashCommandDeclarationWrapper {
    companion object {
        val I18N_PREFIX = I18nKeysData.Commands.Command.Summon
        val tioDoPaveJokes = listOf(
    ...
    inner class TioDoPaveExecutor : LorittaSlashCommandExecutor(), LorittaLegacyMessageCommandExecutor {
        override suspend fun execute(context: UnleashedContext, args: SlashCommandArguments) {
            context.reply(false) {
                embed {
                    author {
                        name = "Tio do Pavê"
                        iconUrl = "https://loritta.website/assets/img/tio_do_pave.jpg"
                    }

                    description = "${tioDoPaveJokes.random()} ${Emotes.LoriOkHand}"
                }
            }
        }
    ...
    inner class FaustaoExecutor : LorittaSlashCommandExecutor(), LorittaLegacyMessageCommandExecutor {
        ...
        override suspend fun execute(context: UnleashedContext, args: SlashCommandArguments) {
            context.reply(false) {
                 embed {
                     author {
                         name = "Faustão"
                         iconUrl = avatars.random()
                     }

                     description = phrases.random().replace("{user}", context.user.asMention)
                 }
            }
        }
    ...
    inner class BemBoladaExecutor : LorittaSlashCommandExecutor(), LorittaLegacyMessageCommandExecutor {
        ...
        override suspend fun execute(context: UnleashedContext, args: SlashCommandArguments) {
            context.reply(false) {
                embed {
                    author {
                        name = "Kenji do Loop Infinito"
                        iconUrl = "https://loritta.website/assets/img/kenji.jpg"
                    }
