    ...
    override suspend fun transform(
        ...
        val receiverUserInfo =
            cachedUserInfos.getOrPut(transaction.receivedBy) {
                KotlinLogging.logger {}.info { "APIInitiatedPaymentSonhosTransactionTransformer#retrieveUserInfoById - UserId: ${transaction.receivedBy}" }

                loritta.lorittaShards.retrieveUserInfoById(transaction.receivedBy)
            }
        val giverUserInfo =
            cachedUserInfos.getOrPut(transaction.givenBy) {
                KotlinLogging.logger {}.info { "APIInitiatedPaymentSonhosTransactionTransformer#retrieveUserInfoById - UserId: ${transaction.givenBy}" }
