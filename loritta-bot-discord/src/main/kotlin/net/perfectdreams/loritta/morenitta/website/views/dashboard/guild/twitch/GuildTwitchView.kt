...
class GuildTwitchView(
    ...
    guild: Guild,
    selectedType: String,
    private val valueOfTheDonationKeysEnabledOnThisGuild: Double,
    ...
    companion object {
        const val MAX_TRACKED_TWITCH_ACCOUNTS = 100
            ...
            div(classes = "cards-with-header") {
                div(classes = "card-header") {
                    ...
                    button(classes = "discord-button primary") {
                        if (MAX_TRACKED_TWITCH_ACCOUNTS > trackedTwitchAccounts.size) {
                                            ...
                                            openEmbeddedModalOnClick(
                                                ...
                                                true,
                                                {
                                                    div {
                                                        ...
                                                        script {
                                                            unsafe {
                                                                // We create a block to avoid variable redeclarationtsu
                                                                raw("""
                                                                    var self = me()
                                                                    {
