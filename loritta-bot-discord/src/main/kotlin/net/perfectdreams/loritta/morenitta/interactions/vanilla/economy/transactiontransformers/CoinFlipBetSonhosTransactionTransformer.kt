    ...
    override suspend fun transform(
        ...
        val winnerUserInfo =
            cachedUserInfos.getOrPut(transaction.winner) {
                KotlinLogging.logger {}.info { "CoinFlipBetSonhosTransactionTransformer#retrieveUserInfoById - UserId: ${transaction.winner}" }

                loritta.lorittaShards.retrieveUserInfoById(transaction.winner)
            }
        val loserUserInfo =
            cachedUserInfos.getOrPut(transaction.loser) {
                KotlinLogging.logger {}.info { "CoinFlipBetSonhosTransactionTransformer#retrieveUserInfoById - UserId: ${transaction.loser}" }
