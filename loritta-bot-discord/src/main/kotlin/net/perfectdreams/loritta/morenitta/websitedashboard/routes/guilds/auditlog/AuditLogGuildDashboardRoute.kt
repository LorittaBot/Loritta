                                                        ...
                                                        span {
                                                            ...
                                                            text(
                                                                when (entry[AuditLogEntries.trackedChangeType]) {
                                                                    ...
                                                                    TrackedChangeType.CREATED_PREDEFINED_MESSAGE -> i18nContext.get(DashboardI18nKeysData.AuditLog.Types.CreatedPredefinedMessage(userInfo?.name ?: "???"))
                                                                    TrackedChangeType.EDITED_PREDEFINED_MESSAGE -> i18nContext.get(DashboardI18nKeysData.AuditLog.Types.EditedPredefinedMessage(userInfo?.name ?: "???"))
                                                                    TrackedChangeType.DELETED_PREDEFINED_MESSAGE -> i18nContext.get(DashboardI18nKeysData.AuditLog.Types.DeletedPredefinedMessage(userInfo?.name ?: "???"))
