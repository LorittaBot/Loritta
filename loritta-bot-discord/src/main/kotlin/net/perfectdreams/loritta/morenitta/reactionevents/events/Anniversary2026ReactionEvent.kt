...
object Anniversary2026ReactionEvent : ReactionEvent() {
    override val internalId: String = "Anniversary2026"
    override val startsAt: Instant = ZonedDateTime.of(2026, 3, 27, 23, 0, 0, 0, Constants.LORITTA_TIMEZONE).toInstant()
    override val endsAt: Instant = ZonedDateTime.of(2026, 3, 30, 23, 59, 59, 0, Constants.LORITTA_TIMEZONE).toInstant()
