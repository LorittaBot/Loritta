...
class LoriAtaProfileCreator(loritta: LorittaBot) : StaticProfileCreator(loritta, "loriAta") {
	override suspend fun create(
		...
		ProfileUtils.getMarriageInfo(loritta, userProfile)?.let { (marriage, marriedWith) ->
			...
			ImageUtils.drawCenteredString(graphics, DateUtils.formatDateDiff(i18nContext, marriage.marriedSince.toEpochMilliseconds(), System.currentTimeMillis(), 3), Rectangle(200 + 280, 270 + 23 + 16, 218, 15), graphics.font)
		}
