...
class GetOverHereCommand(loritta: LorittaBot) : AbstractCommand(loritta, "getoverhere", category = net.perfectdreams.loritta.common.commands.CommandCategory.IMAGES) {
