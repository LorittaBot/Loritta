		...
		if (outputQuality >= 0f && outputQuality <= 1.2f) {
			...
			if (useSunCodec) {
				...
				try {
					...
					val encoder = JPEGCodec!!.getMethod("createJPEGEncoder", java.io.OutputStream::class.java).invoke(JPEGCodec, bas)
					val params = JPEGCodec!!.getMethod("getDefaultJPEGEncodeParam", BufferedImage::class.java).invoke(JPEGCodec, bi)
