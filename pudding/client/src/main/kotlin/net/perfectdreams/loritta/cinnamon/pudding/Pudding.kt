...
class Pudding(
    ...
    companion object {
        ...
        private const val SCHEMA_VERSION = 8 // Bump this every time any table is added/updated!
    ...
    suspend fun createMissingTablesAndColumns(shouldBeUpdated: (String) -> Boolean) {
        ...
        if (schemas.isNotEmpty())
            transaction {
                ...
                if (!System.getProperty("loritta.skipSchemaVersion").toBoolean() && checkIfTableExists(SchemaVersion)) {
                    val schemaVersion =
