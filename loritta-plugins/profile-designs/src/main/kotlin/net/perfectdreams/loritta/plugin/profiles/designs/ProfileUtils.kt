...
object ProfileUtils {
	 ...
	 */
	suspend fun getGlobalExperiencePosition(userProfile: Profile) = loritta.newSuspendedTransaction {
	 ...
	 */
	suspend fun getGlobalEconomyPosition(userProfile: Profile) = loritta.newSuspendedTransaction {
	 ...
	 * @return the user's current local position in the experience ranking
	 */
	suspend fun getLocalExperiencePosition(localProfile: GuildProfile?) = if (localProfile != null) {
