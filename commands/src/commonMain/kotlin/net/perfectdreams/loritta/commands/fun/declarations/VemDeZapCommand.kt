...
object VemDeZapCommand : CommandDeclaration {
    const val LOCALE_PREFIX = "commands.command.vemdezap"
    ...
    override fun declaration() = command(listOf("vemdezap")) {
        description = LocaleKeyData("${LOCALE_PREFIX}.description")
        executor = VemDeZapExecutor
    }
}