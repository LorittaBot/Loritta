...
class ServerInfoCommand : AbstractCommand("serverinfo", listOf("guildinfo"), category = CommandCategory.DISCORD) {
	...
	override suspend fun run(context: CommandContext,locale: LegacyBaseLocale) {
		...
		val owner = lorittaShards.getUserById(ownerId)
		...
		embed.setImage(splashUrl) // Background do Invite da Guild
		...
		embed.addField("👑 ${context.legacyLocale["SERVERINFO_OWNER"]}", owner?.asMention, true) // Dono da Guild
