...
fun GoogleAdSenseAd(id: String, width: Int, height: Int) {
    Ins(attrs = {
        ...
        ref { htmlDivElement ->
            ...
            js("try { (adsbygoogle = window.adsbygoogle || []).push({}); } catch (e) { console.warn(\"Something went wrong while trying to render Google AdSense's ad! Is the user using Adblock?\"); }")
