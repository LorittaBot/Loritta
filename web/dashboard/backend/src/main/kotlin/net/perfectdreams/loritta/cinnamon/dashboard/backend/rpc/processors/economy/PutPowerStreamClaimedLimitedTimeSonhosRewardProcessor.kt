...
import net.perfectdreams.loritta.serializable.StoredPowerStreamClaimedLimitedTimeSonhosRewardSonhosTransaction
            ...
            LorittaDashboardRpcProcessor.DashboardTokenResult.Success -> {
                val result = m.pudding.transaction {
                    ...
                    SimpleSonhosTransactionsLogUtils.insert(
                        ...
                        request.quantity,
                        StoredPowerStreamClaimedLimitedTimeSonhosRewardSonhosTransaction(request.liveId, request.streamId)
                    )
